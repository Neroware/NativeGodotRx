...
public:
    ...
    RxSceneTreeTimeout(Ref<SceneTreeTimer> timer, const std::shared_ptr<SingleAssignmentDisposable>& forward, const std::shared_ptr<SceneTreeTimeoutScheduler>& scheduler, const scheduled_action_t& action, const Variant& state) :
