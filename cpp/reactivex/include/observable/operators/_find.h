#ifndef RX_OBSERVABLE_OPERATORS_FIND_H
#define RX_OBSERVABLE_OPERATORS_FIND_H
...
static observable_op_t find_value_(
    const predicate_t<Variant, uint64_t, rx_observable_t>& predicate, bool yield_index) {
...
#endif // RX_OBSERVABLE_OPERATORS_FIND_H
