...
std::shared_ptr<DisposableBase> MultiAssignmentDisposable::get_disposable() {
    return this->current;
}

void MultiAssignmentDisposable::set_disposable(const std::shared_ptr<DisposableBase>& value) {
    bool should_dispose;
    {
