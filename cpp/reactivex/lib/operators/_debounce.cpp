...
observable_op_t ops::debounce_(const time_delta_t& duetime, const scheduler_t& scheduler) {
...
observable_op_t ops::throttle_with_mapper_(const mapper_t<rx_observable_t, Variant>& throttle_duration_mapper) {
