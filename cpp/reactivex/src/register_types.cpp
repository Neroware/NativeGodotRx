...
void initialize_reactivex_module(ModuleInitializationLevel p_level) {
	...
	ClassDB::register_class<rx::wrappers::RxReadOnlyReactiveProperty>(true);
	// observer
	...
	// templates
	ClassDB::register_class<rx::wrappers::RxOnNext>();
	ClassDB::register_class<rx::wrappers::RxOnError>();
